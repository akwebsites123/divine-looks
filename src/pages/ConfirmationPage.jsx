...
export default function ConfirmationPage({ booking, onBookAnother }) {
  ...
  const shareText = `Just booked ${booking.service.name} at ${config.brand} via divine looks. Zero investment mein apna booking site:"https://divine-looks1.prealpha012.workers.dev"`;
